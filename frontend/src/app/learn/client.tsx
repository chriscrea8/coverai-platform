    ...
    <div style={{ minHeight: '100vh', background: 'radial-gradient(ellipse 70% 40% at 50% 0%, rgba(26,58,143,0.2) 0%, transparent 70%), #0A0F1E', color: '#fff' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <Link href="/chat" style={{ padding: '8px 16px', borderRadius: 10, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', fontSize: 13, textDecoration: 'none' }}>Ask ARIA 🤖</Link>

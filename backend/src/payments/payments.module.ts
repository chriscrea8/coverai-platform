import { Module, Injectable, Logger, BadRequestException, NotFoundException, Controller, Get, Post, Body, Headers, Req, Param, UseGuards } from '@nestjs/common';
...
export class PaymentsController {
  ...
  @Get('history') @UseGuards(AuthGuard('jwt')) @ApiBearerAuth('JWT')
  getHistory(@CurrentUser('id') userId: string) { return this.paymentsService.getHistory(userId); }
}
